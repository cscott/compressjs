...
var MTFModel = function(coder, size, max_prob, betterEscape) {
    this.coder = coder;
...
MTFModel.factory = function(coder, max_prob) {
    return function(size) { return new MTFModel(coder, size, max_prob); };
};
...
MTFModel.compressFile = Util.compressFileHelper(MTF_MAGIC, function(inStream, outStream, fileSize, props, finalByte) {
...
MTFModel.decompressFile = Util.decompressFileHelper(MTF_MAGIC, function(inStream, outStream, fileSize) {
