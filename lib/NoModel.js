...
var NOMODEL_MAGIC = 'nomo';
NoModel.compressFile = Util.compressFileHelper(NOMODEL_MAGIC, function(inStream, outStream, fileSize, props) {
...
NoModel.decompressFile = Util.decompressFileHelper(NOMODEL_MAGIC, function(inStream, outStream, fileSize) {
