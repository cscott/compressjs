...
var HUFFMAN_MAGIC = 'huff';
Huffman.compressFile = Util.compressFileHelper(HUFFMAN_MAGIC, function(input, output, size, props) {
...
Huffman.decompressFile = Util.decompressFileHelper(HUFFMAN_MAGIC, function(input, output, size) {
