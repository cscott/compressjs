 ...
 *  Encodes 16-bit distances 1-0x10000
...
define(['./Util'],function(Util){
    ...
    // ModelFunction will be called with arguments 2, 4, 8, 16, etc
    // and must return a constructor function
    var DeflateDistanceModel = function(size, extraStates,
                                        lgDistanceModelFactory,
                                        lengthBitsModelFactory) {
        var i;
        var bits = Util.ceilLn2(size-1);
    ...
    DeflateDistanceModel.prototype.encode = function(distance) {
        ...
        var lgDistance = Util.ceilLn2(distance);
