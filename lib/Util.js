...
define(['./makeBuffer','./freeze','./Stream'],function(makeBuffer, freeze, Stream) {
    ...
    Util.makeU32Buffer = function(size) {
        if (typeof(Uint32Array) !== 'undefined') {
            ...
            return zerofillTA(new Uint32Array(size));
        }
        // fallback
        return zerofill(new Array(size));
    };
