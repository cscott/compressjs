...
define(['./RangeCoder','./Stream','./Util'],function(RangeCoder,Stream,Util){
    ...
    var SIMPLE_MAGIC = 'smpl';

    var Simple = Object.create(null);
    Simple.compressFile = Util.compressFileHelper(SIMPLE_MAGIC, function(input, output, size, props, finalByte) {
    ...
    Simple.decompressFile = Util.decompressFileHelper(SIMPLE_MAGIC, function(input, output, size) {
