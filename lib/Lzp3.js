...
define(['./BitStream', './DeflateDistanceModel', './DefSumModel', './MTFModel', './Huffman', './RangeCoder', './Stream', './Util'],function(BitStream, DeflateDistanceModel, DefSumModel, MTFModel, Huffman, RangeCoder, Stream, Util){
