...
define(['./DefSumModel', './EscModel', './Huffman', './RangeCoder', './Util'],function(DefSumModel, EscModel, Huffman, RangeCoder, Util){

var Lzp3 = Object.create(null);

var USE_HUFFMAN_CODE = false; // use huffman / use range coder
...
Lzp3.compressFile = function(inStream, outStream, props) {
  ...
  if (USE_HUFFMAN_CODE) {
    ...
    if (USE_DEFSUM) {
      Coder2 = function(size) {
        DefSumModel.call(this, range, size);
      };
      Coder2.prototype = Object.create(DefSumModel.prototype);
    } else {
      Coder2 = Coder;
    }
  ...
  var huffLiteral= new Context1Model(Coder2, (fileSize<0) ? 257 : 256);
...
Lzp3.decompressFile = function(inStream, outStream) {
  ...
  var Coder, Coder2;
  var finish, readBit, sparseLimit;
  if (use_huffman_code) {
    // huffman contexts
    ...
    if (USE_DEFSUM) {
      Coder2 = function(size) {
        DefSumModel.call(this, range, size, true/*is decoder*/);
      };
      Coder2.prototype = Object.create(DefSumModel.prototype);
    } else {
      Coder2 = Coder;
