...
define(['./BitStream', './DefSumModel', './Huffman', './LogDistanceModel', './MTFModel', './NoModel', './RangeCoder', './Stream', './Util'],function(BitStream, DefSumModel, Huffman, LogDistanceModel, MTFModel, NoModel, RangeCoder, Stream, Util){
