...
define(['./BitStream', './DeflateDistanceModel', './DefSumModel', './EscModel', './Huffman', './RangeCoder', './Stream', './Util'],function(BitStream, DeflateDistanceModel, DefSumModel, EscModel, Huffman, RangeCoder, Stream, Util){
