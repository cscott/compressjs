...
var MarkovNode = function(coder, size, optModel) {
  ...
  this.model = optModel ? optModel.clone() :
    new MTFModel(coder, size, MAX_MODEL_PROB);
...
Dmc.compressFile = Util.compressFileHelper(DMC_MAGIC, function(inStream, outStream, fileSize, props) {
...
Dmc.decompressFile = Util.decompressFileHelper(DMC_MAGIC, function(inStream, outStream, fileSize) {
