...
var optimizeHuffmanGroups = function(groups, targetGroups, input, selectors) {
...
var compressBlock = function(block, length, outStream) {
  ...
  // bloat if the input filesize is very small)
  ...
  optimizeHuffmanGroups(groups, targetGroups, A, selectors);
