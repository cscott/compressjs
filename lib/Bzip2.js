...
define(['./freeze','./makeBuffer','./BitStream','./Stream','./Util'], function(freeze, makeBuffer, BitStream, Stream, Util) {
...
Bunzip.prototype._get_next_block = function() {
  ...
  var h = reader.readBits(24);
  h = (h * (1<<24)) + reader.readBits(24); // 48-bit integer
  if (h === SQRTPI) { // last block
    return false; /* no more blocks */
  }
  if (h !== WHOLEPI)
    _throw(Err.NOT_BZIP_DATA);
  reader.readBits(32); // ignoring CRC codes; is this wise?
